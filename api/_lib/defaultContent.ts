// Cópia server-side (sem alias "@/") do conteúdo padrão do site.
// Mantenha em sincronia manual com src/data/defaultContent.ts — é o seed
// gravado no blob `content/site.json` na primeira leitura (lazy init).
export const DEFAULT_SITE_CONTENT = {
  ...
  hero: {
    videoUrl: '/assets/videos/ambiente.mp4',
    imageUrl: '/assets/images/hero-bg.webp',
    ctaPrimaryLabel: 'AGENDAR HORÁRIO',
    ctaSecondaryLabel: 'CONHECER O ESPAÇO',
  },

  videoSection: {
    title: 'O Espaço em Vídeo',
    eyebrow: 'Conheça o Ambiente',
    videoUrl: '/assets/videos/ambiente.mp4',
    posterUrl: '/assets/images/video-thumb.jpg',
  },
