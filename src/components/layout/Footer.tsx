      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8">
          <div className="flex flex-col gap-4">
            <img src="/assets/logo/logo-horizontal-branca.png" alt={business.name} className="h-10 w-auto object-contain object-left" />
            ...
            <a href={business.instagramUrl} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-white/50 hover:text-olive-light transition-colors text-sm">
              <Instagram size={15}/>@{business.instagram}
            </a>
          </div>
          <div className="flex flex-col gap-4">
        ...
        <div className="mt-12 pt-6 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="font-inter text-xs text-white/30">© {year} {business.name}. Todos os direitos reservados.</p>
