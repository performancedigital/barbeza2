    ...
    <section className="section-padding bg-natural-alt">
      <div className="max-w-5xl mx-auto px-6 md:px-10">
        <div className="text-center mb-12">
          <p className="font-inter text-xs text-forest tracking-[0.35em] uppercase mb-3">{videoSection.eyebrow}</p>
          <h2 className="font-raleway font-black text-4xl md:text-5xl text-ink mb-4">{videoSection.title}</h2>
        ...
        <div ref={ref} className="relative rounded-2xl overflow-hidden shadow-[0_8px_60px_rgba(61,90,61,0.15)] border border-natural-border transition-all duration-700"
          ...
          <div className="aspect-video">
            <video key={videoSection.videoUrl} className="w-full h-full object-cover" controls preload="metadata" poster={videoSection.posterUrl}>
